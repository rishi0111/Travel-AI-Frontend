      ...
      <div className="md:ms-[275px] h-screen overflow-y-auto flex-1">
        ...
        <div className="max-w-[1240px] lg:px-[30px] sm:px-[15px] px-[10px] mx-auto py-[30px]">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center max-w-[880px] gap-[14px]">
                <div className='bg-[#DCFAED] rounded-[10px] p-[14px]'>
                    <p className='text-sm text-[#05073CE5]'>Total Spent</p>
                    <h6 className='text-[#0EAD69] text-[20px] font-semibold'>$430.00</h6>
                    <span className='text-sm text-[#49454FCC]'>Last 30 Days</span>
                </div>
                <div className='bg-[#F3F4F6] rounded-[10px] p-[14px]'>
                    <p className='text-sm text-[#05073CE5]'>Pending Payments</p>
                    <h6 className='text-[#0D3FC6] text-[20px] font-semibold'>$100.00</h6>
                    <span className='text-sm text-[#49454FCC]'>Last 30 Days</span>
                </div>
                <div className='bg-[#CFD9F4CC] rounded-[10px] p-[14px]'>
                    <p className='text-sm text-[#05073CE5]'>Pending Method</p>
                    <h6 className='text-[#0D3FC6] text-[20px] font-semibold'>3</h6>
                    <span className='text-sm text-[#49454FCC]'>Active Card</span>
                </div>
            </div>
                    ...
                    <table className='w-full whitespace-nowrap'>
                        <thead>
                            <tr className='bg-[#F9FAFB] border-b border-[#E5E7EB]'>
                                <th className='text-[#6B7280] text-xs font-semibold px-[20px] py-[12px] text-start'>Date</th>
                                <th className='text-[#6B7280] text-xs font-semibold px-[20px] py-[12px] text-start'>Description</th>
                                <th className='text-[#6B7280] text-xs font-semibold px-[20px] py-[12px] text-start'>Amount</th>
                                <th className='text-[#6B7280] text-xs font-semibold px-[20px] py-[12px] text-start'>Status</th>
                                <th className='text-[#6B7280] text-xs font-semibold px-[20px] py-[12px] text-start'>Payment Method</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className='border-b border-[#E5E7EB]'>
                                <td className='text-[#05073C] text-sm px-[20px] py-[14px]'>Apr 15, 2025</td>
                                <td className='px-[20px] py-[14px]'>
                                    <div>
                                        <h6 className='text-[#05073C] text-sm font-semibold'>Bali Beach Resort & Spa</h6>
                                        <p className='text-[#6B7280] text-xs'>Payment</p>
                                    </div>
                                </td>
                                <td className='text-[#05073C] text-sm font-semibold px-[20px] py-[14px]'>$1,450</td>
                                <td className='px-[20px] py-[14px]'>
                                    <div className='bg-[#DCFAED] text-[#0EAD69] text-sm font-semibold px-[12px] py-[2px] rounded-[70px] inline-block text-center'>Success</div>
                                </td>
                                <td className='px-[20px] py-[14px] text-[#6B7280] text-sm font-semibold'>Visa ****4582</td>
                                <td>
                                    <a href='#' className='text-[#0D3FC6] text-sm font-semibold'>View Receipt</a>
                                </td>
                            </tr>
                            <tr className='border-b border-[#E5E7EB]'>
                                <td className='text-[#05073C] text-sm px-[20px] py-[14px]'>Apr 15, 2025</td>
                                ...
                                <td className='text-[#05073C] text-sm font-semibold px-[20px] py-[14px]'>$1,450</td>
                                <td className='px-[20px] py-[14px]'>
                                    <div className='bg-[#FEF9C3] text-[#854D0E] text-sm font-semibold px-[12px] py-[2px] rounded-[70px] inline-block text-center'>Processing</div>
                                </td>
                                <td className='px-[20px] py-[14px] text-[#6B7280] text-sm font-semibold'>Visa ****4582</td>
                                <td>
                                    <a href='#' className='text-[#0D3FC6] text-sm font-semibold'>View Receipt</a>
                            ...
                            <tr className='border-b border-[#E5E7EB]'>
                                ...
                                <td className='text-[#05073C] text-sm font-semibold px-[20px] py-[14px]'>$1,450</td>
                                <td className='px-[20px] py-[14px]'>
                                    <div className='bg-[#FEE2E2] text-[#991B1B] text-sm font-semibold px-[12px] py-[2px] rounded-[70px] inline-block text-center'>Failed</div>
                                </td>
                                <td className='px-[20px] py-[14px] text-[#6B7280] text-sm font-semibold'>Visa ****4582</td>
                                <td>
                                    <a href='#' className='text-[#0D3FC6] text-sm font-semibold'>View Receipt</a>
